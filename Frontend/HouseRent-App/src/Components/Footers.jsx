function Footers() {
  return (
    <>
      {/* ========== FOOTER ========== */}
      <footer className="mt-8 md:mt-12 bg-gray-800 w-full">
        <div className="mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
            ...
            <div className="col-span-2">
              ...
              <form>
                <div className="mt-4 flex flex-col items-center gap-2 sm:flex-row sm:gap-3 bg-white rounded-lg p-2">
                  ...
                  <a
                    className="w-full sm:w-auto whitespace-nowrap p-3 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-gradient-to-tl from-blue-600 to-violet-600  text-white focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none"
                    href="#"
                  >
                    Subscribe
                  </a>
                ...
                <p className="mt-3 text-sm text-gray-400">
                  Exclusive deals and updates. No spam, we promise!
                </p>
              </form>
            </div>
            {/* End Col */}
          ...
          <div className="mt-5 sm:mt-12 grid gap-y-2 sm:gap-y-0 sm:flex sm:justify-between sm:items-center">
            <div className="flex justify-between items-center">
              <p className="text-sm text-gray-400">© 2024 Rentify.</p>
            </div>
            {/* End Col */}
            {/* Social Brands */}
            <div>
